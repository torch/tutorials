...
input_word_indexes =  input[{1, {}}]:type('torch.LongTensor'); -- converts matrix to a vector.
...
inputs_to_softmax = hid_to_output_weights:transpose(1,2) * hidden_layer_state +  torch.repeatTensor(output_bias, 1, batchsize); -- (a)
-- Options
--[[
